...
export async function getMonthlyReportData(
  ...
  // 4. Asientos del Periodo (Libro Diario)
  ...
  // 5. Saldo Inicial (Calculado sumando todo lo anterior a startDate)
  ...
  if (!prevError && prevEntries) {
    prevEntries.forEach((e) => {
      ...
      initialBalances[e.account_code] =
        current + (e.debit || 0) - (e.credit || 0);
    });
  }
